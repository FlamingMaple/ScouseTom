...
These are the front Current Source Panel Messages

Wind2 represents the text for the smaller window at the bottom of the screen
...
//################## Warnings ################
String MSG_AMP_RANGE = "AMP OUT OF RANGE";
